...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.logo','data' => ['class' => 'w-12 h-12 transition-transform duration-500 group-hover:scale-110']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-12 h-12 transition-transform duration-500 group-hover:scale-110']); ?>
...
<?php endif; ?>
            ...
            <div class="flex flex-wrap justify-center md:justify-start items-center space-x-6 md:space-x-8 lg:space-x-10 pt-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['social_youtube'] ?? ''): ?>
                    <a href="<?php echo e($settings['social_youtube']); ?>" target="_blank" class="text-mn-slate hover:text-mn-black transition-colors lowercase font-sans text-xs md:text-sm tracking-tight border-b border-transparent hover:border-mn-black pb-0.5">YouTube</a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['social_x'] ?? ''): ?>
                    <a href="<?php echo e($settings['social_x']); ?>" target="_blank" class="text-mn-slate hover:text-mn-black transition-colors lowercase font-sans text-xs md:text-sm tracking-tight border-b border-transparent hover:border-mn-black pb-0.5">X</a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['social_instagram'] ?? ''): ?>
                    <a href="<?php echo e($settings['social_instagram']); ?>" target="_blank" class="text-mn-slate hover:text-mn-black transition-colors lowercase font-sans text-xs md:text-sm tracking-tight border-b border-transparent hover:border-mn-black pb-0.5">Instagram</a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings['social_rss'] ?? ''): ?>
                    <a href="<?php echo e($settings['social_rss']); ?>" class="text-mn-slate hover:text-mn-black transition-colors lowercase font-sans text-xs md:text-sm tracking-tight border-b border-transparent hover:border-mn-black pb-0.5">RSS</a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
        ...
        <div class="hidden md:flex md:col-span-3 flex-col space-y-6 md:text-left">
            ...
            <div class="h-48 overflow-y-auto no-scrollbar rounded-lg border border-mn-pearl/50 p-2">
                <a class="twitter-timeline" 
                   ...
                   href="<?php echo e($settings['social_x'] ?? 'https://twitter.com/editorial'); ?>">
                   Tweets by MN
                </a> 
    ...
    <div class="max-w-7xl mx-auto mt-16 md:mt-24 pt-10 border-t border-mn-pearl flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 text-center md:text-left">
        <span class="text-[9px] text-mn-slate uppercase tracking-[0.5em] font-bold">© <?php echo e(date('Y')); ?> MN Editorial — Designed for Clarity.</span>
...
<?php /**PATH /Users/mcorucu/.gemini/antigravity/playground/solitary-viking/resources/views/components/footer.blade.php ENDPATH**/ ?>