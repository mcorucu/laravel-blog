    ...
    <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <a href="/" class="flex items-center space-x-3 group active:scale-95 transition-transform duration-200">
                <x-logo class="w-10 h-10 group-hover:opacity-80 transition-opacity" />
        ...
        <div class="flex items-center space-x-3 md:space-x-4">
            ...
            <!-- RSS Feed -->
            <a href="{{ \App\Models\Setting::where('key', 'rss_feed_url')->value('value') ?? '/rss' }}" target="_blank" class="text-mn-slate hover:text-mn-black transition-colors p-2 rounded-full hover:bg-mn-pearl/50" title="RSS Feed">
